...
<div class="container">
  ...
  <section class="images-section">
    ...
    <div class="screenshots-grid">
      <div class="screenshot-card">
        <img src="{{ '/assets/images/coverflow.png' | relative_url }}" alt="Coverflow view" class="screenshot-image">
        <p class="screenshot-caption">Browse your music with the coverflow view</p>
      </div>
      <div class="screenshot-card">
        <img src="{{ '/assets/images/playing.png' | relative_url }}" alt="Playing view" class="screenshot-image">
  ...
  <section class="footer-section">
    <h2>📄 License</h2>
    <p>See <a href="{{ '/LICENSE' | relative_url }}">LICENSE</a> file for details.</p>
